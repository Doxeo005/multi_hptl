...
class Insurance extends MX_Controller
{
    ...
    function getInsuranceCompany()
    {
        ...
        foreach ($data['insurance_companys'] as $insurance_company) {
            ...
            $options1 = '<a type="button" class="btn btn-primary btn-sm editbutton" title="' . lang('edit') . '" data-toggle="modal" data-id="' . $insurance_company->id . '"><i class="fa fa-edit"> </i> ' . lang('edit') . '</a>';
