    ...
    function importPatient($file, $tablename) {
        ...
        foreach ($object->getWorksheetIterator() as $worksheet) {
            ...
            if ($headerexist) {
                ...
                show_swal('feedback', lang('successful_data_import'));
                show_swal('message', $message);
            } else {
                show_swal('feedback', lang('wrong_file_format'));
            }
        }
