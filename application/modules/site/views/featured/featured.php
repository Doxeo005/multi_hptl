                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($featureds as $featured) { ?>
                                        <tr class="">
                                            ...
                                            <td class="no-print">
                                                <button type="button" class="btn btn-info btn-sm editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $featured->id; ?>"><i class="fa fa-edit"> </i></button>
