...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo lang('time_schedule'); ?> (<?php echo $doctor_details->name; ?>)</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addSchedule" class="clearfix form-row" method="post" enctype="multipart/form-data">
                    <div class="panel doctor_div col-md-6">
                        <label for="exampleInputEmail1"> <?php echo lang('doctor'); ?> &ast;</label>
                        <select class="form-control m-bot15 js-example-basic-single" name="doctor" id="doctorchoose" value='' required="">
