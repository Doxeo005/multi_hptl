<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo lang('invoice') ?> # <?php echo $payment->id; ?></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="third_th">
                                                ...
                                                <br><?php echo $appointment_details->time_slot; ?> </td>
                    ...
                    <div class="col-md-7 no-print card card-body">
                        <form role="form" action="finance/sendInvoice" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" name="submit" class="btn btn-success float-left mb-1"><i
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="hidden insurance_div">
                                ...
                                <div class="">
                                    ...
                                    <div class="">
                                        <textarea class="form-control" name="insurance_details" rows="2" cols="20"></textarea>
                                    </div>
