                ...
                <div class="col-8">
                    <div class="card">
                        ...
                        <div class="col-md-12 no-print mt-4 ml-2">
                            <form role="form" class="f_report" action="finance/patientPaymentHistory" method="post"
                                enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control dpd1" name="date_from"
                                                value="<?php if (!empty($date_from)) echo date('m/d/Y', $date_from); ?>"
                                            ...
                                            <input type="text" class="form-control dpd2" name="date_to"
                                                value="<?php if (!empty($date_to)) echo date('m/d/Y', $date_to); ?>"
                                                placeholder="<?php echo lang('date_to'); ?>" readonly>

                                            <input type="hidden" class="form-control dpd2" name="patient"
                                    ...
                                    <div class="col-md-6">
                                        <button type="submit" name="submit"
                                            class="btn btn-secondary"><?php echo lang('submit'); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                            ...
                                            <a class="btn-sm btn-info edit_pay" title="<?php echo lang('edit'); ?>"
                                                href="finance/editPayment?id=<?php echo $payment->id; ?>"><i
                                                    class="fa fa-edit"> </i></a>
                                            <?php }
                                                            } ?>
                                            <?php } ?>
                                            <a class="btn-sm invoicebutton btn-warning"
                                                title="<?php echo lang('invoice'); ?>"
                                                href="finance/invoice?id=<?php echo $payment->id; ?>"><i
                                            ...
                                            <?php if ($payment->payment_from == 'payment' && empty($payment->payment_from)) {
                                                                ...
                                                                if (count($lab_reports_previous) == count($lab_pending) || empty($lab_reports_previous)) {
                                                            ?>
                                            <a class="btn-sm btn-info delete_button"
                                                title="<?php echo lang('delete'); ?>" style="width: 25%;"
                                                href="finance/delete?id=<?php echo $payment->id; ?>"
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                            <button type="button" class="btn-sm btn-info editbutton edit_pay"
                                                title="<?php echo lang('edit'); ?>" data-toggle="modal"
                                                data-id="<?php echo $deposit->id; ?>"><i class="fa fa-edit"></i>
                                            </button>
                                            <?php } ?>
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                            <a class="btn-sm btn-info delete_button edit_pay"
                                                title="<?php echo lang('delete'); ?>"
                                                href="finance/deleteDeposit?id=<?php echo $deposit->id; ?>&patient=<?php echo $patient->id; ?>"
                                                onclick="return confirm('Are you sure you want to delete this item?');"><i
                                                    class="fa fa-trash"></i></a>
                                            <?php } ?>
                                        </td>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-body profile">
                                ...
                                <p> <?php echo lang('address'); ?>: <?php echo $patient->address; ?></p>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <?php echo $settings->currency; ?> <?php echo $total_bill; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-body">
                <form role="form" action="finance/deposit" id="deposit-form" class="clearfix" method="post"
                    ...
                    <div class="form-group payment_class">
                        ...
                        <select class="form-control m-bot15 js-example-basic-single" id="payment_id1" name="payment_id"
                            value='' required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="due_amount" name="due" value='' placeholder=""
                            readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('deposit_amount'); ?></label>
                        <input type="text" class="form-control" name="deposited_amount" id="deposited_amount" value=''
                    ...
                    <div class="form-group">
                        ...
                        <div class="hidden insurance_div">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    <textarea class="form-control" name="insurance_details" rows="2"
                                        cols="20"></textarea>
                                </div>
                    ...
                    <div class="form-group cardsubmit d-none">
                        ...
                        <button type="submit" name="pay_now" id="submit-btn" class="btn btn-info btn-block float-right"
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editDepositform" action="finance/deposit" class="clearfix" method="post"
                    enctype="multipart/form-data">
                    <div class=payment_label">
                        <label for="exampleInputEmail1"><?php echo lang('invoice'); ?></label>
                        <select class="form-control m-bot15 js-example-basic-single" id="payment_id2" name="payment_id"
                            value=''>
                            <option value="">Select .....</option>
                            <?php foreach ($payments as $payment) {
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('due'); ?> <?php echo lang('amount'); ?></label>
                        <input type="text" class="form-control" id="due_amount1" name="due" value='' placeholder=""
                            readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('deposit_amount'); ?></label>
                        <input type="text" class="form-control" name="deposited_amount" id="deposited_amount1" value=''
                            placeholder="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="hidden insurance_div1">
                            ...
                            <div class="form-group" style="margin-top:10px;">
                                ...
                                <div class="company_div1">
                                    <select class="form-control m-bot15 js-example-basic-single"
                                        name="insurance_company" id="insurance_company1" value=''>
                                        <option value="">Select Company</option>
                                        <?php foreach ($insurance_companys as $insurance_company) { ?>
                                        <option value="<?php echo $insurance_company->id; ?>" <?php
                                                                                                if (!empty($setval)) {
                        ...
                        <div class="card1">
                            ...
                            <div class="col-md-12 payment pad_bot">
                                <label for="exampleInputEmail1"> <?php echo lang('card'); ?>
                                    <?php echo lang('number'); ?></label>
                                <input type="text" class="form-control pay_in" id="card1" name="card_number"
                                    value='<?php
                            ...
                            <div class="col-md-8 payment pad_bot">
                                <label for="exampleInputEmail1"> <?php echo lang('expire'); ?>
                                    <?php echo lang('date'); ?></label>
                                <input type="text" class="form-control pay_in" data-date="" id="expire1"
                                    data-date-format="MM YY" placeholder="Expiry (MM/YY)" name="expire_date"
                                    maxlength="7" aria-describedby="basic-addon1"
                                    value='<?php
                            ...
                            <div class="col-md-4 payment pad_bot">
                                <label for="exampleInputEmail1"> <?php echo lang('cvv'); ?> </label>
                                <input type="text" class="form-control pay_in" id="cvv1" maxlength="3" name="cvv_number"
                                    value='<?php
                    ...
                    <div class="form-group cardsubmit1 d-none">
                        <button type="submit" name="pay_now" id="submit-btn1" class="btn btn-info btn-block float-right"
                            <?php if ($settings->payment_gateway == 'Stripe') {
                ...
                <div class="card-primary">
                    ...
                    <div class="row">
                        <div class="card col-md-3 no-print">
                            <a class="btn btn-sm btn-secondary invoice_button" onclick="javascript:window.print();"><i
                                    class="fa fa-print"></i> <?php echo lang('print'); ?> </a>
                        </div>

                        <div class="col-md-3 text-center invoice-btn clearfix down">
