                                        ...
                                        <div class="col-md-12 row">
                                            <div class="col-md-12 payment pad_bot">
                                                <label for="exampleInputEmail1"><?php echo lang('patient'); ?>
                                                    &ast;</label>
                                                <select class="form-control m-bot15  pos_select" id="pos_select"
                                                    ...
                                                    <option style="color: red; font-size: 18px;"
                                                        value="<?php echo 'add_new'; ?>"><?php echo lang('add_new'); ?>
                                                    </option>
                                                    <?php    } ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="pos_client row" style="display: none;">
                                                ...
                                                <div class="col-md-6 payment pad_bot">
                                                    <label for="exampleInputEmail1"> <?php echo lang('patient'); ?>
                                                        <?php echo lang('email'); ?> &ast;</label>
                                                    <input type="email" class="form-control pay_in" name="p_email"
                                                        id="p_email"
                                                        value='<?php
                                                                                                                                        if (!empty($payment)) {
                                                                                                                                            echo $patients->email;
                                                ...
                                                <div class="col-md-8 payment pad_bot">
                                                    ...
                                                    <div class="input-group m-bot15">
                                                        ...
                                                        <input type="number" class="form-control input-group-addon"
                                                            min="0" max="12" name="months"
                                                            value='<?php
                                                                                                                                                            if (!empty($payment)) {
                                                                                                                                                                echo $age[1];
                                                                                                                                                            } elseif (!empty($draft->age)) {
                                            ...
                                            <div class="col-md-12 payment pad_bot">
                                                ...
                                                <select class="form-control m-bot15  add_doctor" id="add_doctor"
