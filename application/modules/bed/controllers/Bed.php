...
class Bed extends MX_Controller
{
    ...
    function getBedList()
    {
        ...
        foreach ($data['beds'] as $bed) {
            ...
            $option2 = '';
            if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Doctor', 'Accountant'))) {
                $option1 = '<button type="button" class="btn btn-primary btn-sm btn_width editbutton" data-toggle="modal" data-id="' . $bed->id . '"><i class="fa fa-edit"> </i> ' . lang('') . '</button>';
            }
            if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Doctor', 'Accountant'))) {
            ...
            if (!empty($servicename)) {
                if ($this->ion_auth->in_group(array('admin'))) {
                    $option .= '<tr id="' . $service->date . '-' . $service_update . '">
                                                        ...
                                                        <td class="no-print" id="delete-service-' . $date_explode[0] . '-' . $servicename->id . '"><button type="button" class="btn btn-danger btn-sm btn_width delete_service" title=' . lang('delete') . ' data-toggle=" "data-id="' . $service->id . "**" . $service_update . '"><i class="fa fa-trash"></i></button></td>
                                                    </tr>';
                } else {
                    if (empty($service->payment_id)) {
                        $option .= '<tr id="' . $service->date . '-' . $service_update . '">
            ...
            if (!empty($servicename)) {
                if ($this->ion_auth->in_group(array('admin'))) {
                    $option .= '<tr id="' . $diagnostic->date . '-' . $diagnostic_update . '">
                                                        ...
                                                        <td class="no-print" id="delete-diagnostic-' . $date_explode[0] . '-' . $servicename->id . '"><button type="button" class="btn btn-danger btn-sm btn_width delete_diagnostic" title=' . lang('delete') . ' data-toggle=" "data-id="' . $diagnostic->id . "**" . $diagnostic_update . '"><i class="fa fa-trash"></i></button></td>
                                                    </tr>';
                } else {
                    if (empty($diagnostic->payment_id)) {
                        $option .= '<tr id="' . $diagnostic->date . '-' . $diagnostic_update . '">
                        ...
                        if (in_array($servicename->id, $pay_diagnostic_new)) {
                            ...
                            $option .= '<tr id="' . $diagnostic->date . '-' . $diagnostic_update . '">
                                                        ...
                                                        <td>' . $diagnostic->quantity . '  </td>
                                                        <td>' . $settings->currency . ' ' . $diagnostic->quantity * $price . '</td>
                                                        <td class="no-print" id="delete-diagnostic-' . $date_explode[0] . '-' . $servicename->id . '"><button type="button" class="btn btn-danger btn-sm btn_width delete_service" title=' . lang('delete') . ' data-toggle=" "data-id="' . $diagnostic->id . "**" . $diagnostic_update . '"><i class="fa fa-trash"></i></button></td>
                                                    </tr>';
                        }
                    }
                }
    ...
    function getServiceByAllotmentId()
    {
        ...
        foreach ($all_services as $service) {
            ...
            $option = '<td class="no-print" id="delete-service-' . date("d") . '-' . $service->id . '"><button type="button" class="btn btn-danger btn-sm btn_width delete_service" title=' . lang("delete") . ' data-toggle="" data-id="' . $service->id . "**" . $service->service . '"><i class="fa fa-trash"></i></button></td>';
            $info[] = array(
                $service_name->name,
    ...
    function getDiagnosticByAllotmentId()
    {
        ...
        foreach ($all_diagnostics as $diagnostic) {
            ...
            $option = '<td class="no-print" id="delete-diagnostic-' . date("d") . '-' . $diagnostic->id . '"><button type="button" class="btn btn-danger btn-sm btn_width delete_diagnostic" title=' . lang("delete") . ' data-toggle="" data-id="' . $diagnostic->id . "**" . $diagnostic->payment_procedure . '"><i class="fa fa-trash"></i></button></td>';
            $info[] = array(
                $payment_procedure,
    ...
    function getMedicineByAllotmentId()
    {
        ...
        foreach ($all_medicines as $medicine) {
            ...
            $option = '<td class="no-print" id="delete-' . $medicine->id . '"><button type="button" class="btn btn-danger btn-sm btn_width delete_medicine" title=' . lang("delete") . ' data-toggle="" data-id="' . $medicine->id . '"><i class="fa fa-trash"></i></button></td>';
            $info[] = array(
