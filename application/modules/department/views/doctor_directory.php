...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> <?php echo $department->name; ?>  <?php echo lang('doctor_directory'); ?></h1>
                </div>
                <div class="col-sm-6">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo lang('edit_doctor'); ?></h5>
        ...
        <form id="editDoctorForm" action="doctor/addNew" method="post" enctype="multipart/form-data">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select class="form-control" name="department">
                <?php foreach ($departments as $department) { ?>
                  <option value="<?php echo $department->id; ?>" <?php if (!empty($doctor->department) && $department->name == $doctor->department) { echo 'selected'; } ?> >
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="profile" placeholder="">
            </div>
            <div class="form-group col-md-6">
